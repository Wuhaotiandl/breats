...
def assembly(data_path):
    ...
    for path in path_list:
        ...
        cut_img = cutting(256, 0, img_1, bias_x, bias_y)
        cut_mask = cutting(256, 0, mask_1, bias_x, bias_y)
...
def train(data_path, model_save_path):
    ...
    model = unet()
    model.fit(train_img, train_mask, epochs=10, batch_size=2, shuffle=True)
    model.save(model_save_path)


data_path = r'F:\t1\masks'
model_save_path = r'F:\t1\masks\unet2d.h5'
